				...
				<div class="red-bar">		
					<div class="administration-trombi">
						<div class="row">
							...
							<form role="form" class="form-vertcial col-md-9 col-sm-8 col-xs-8" method="post" action="index.php">
								<fieldset>
									<legend><span style="color: #6DA542;"> <em>Administration - Recherche</em></span><a href="../index.php" class="btn" style="margin-left: 80px;"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a></legend>
